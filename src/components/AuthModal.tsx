    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in">
      <div className="w-full max-w-lg bg-white border border-slate-200 rounded-2xl shadow-xl p-6 sm:p-8 relative text-slate-900">
        ...
        <div className="text-center mb-6">
          <div className="w-12 h-12 rounded-xl bg-slate-100 border border-slate-200 text-[#0b1f33] flex items-center justify-center mx-auto mb-3 shadow-xs">
            <School className="w-6 h-6" />
          </div>
          <div className="text-[11px] font-bold text-[#0b1f33] uppercase tracking-wider mb-0.5">
            Pragati University
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 bg-white border border-slate-300 rounded-lg text-xs text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:border-[#0b1f33] focus:ring-1 focus:ring-[#0b1f33]"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 bg-white border border-slate-300 rounded-lg text-xs text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:border-[#0b1f33] focus:ring-1 focus:ring-[#0b1f33] uppercase font-mono font-medium"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs text-slate-900 focus:outline-hidden focus:border-[#0b1f33] focus:ring-1 focus:ring-[#0b1f33]"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 bg-white border border-slate-300 rounded-lg text-xs text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:border-[#0b1f33] focus:ring-1 focus:ring-[#0b1f33] font-medium"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 bg-white border border-slate-300 rounded-lg text-xs text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:border-[#0b1f33] focus:ring-1 focus:ring-[#0b1f33]"
                  />
                </div>
              </div>
            </>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 mt-2 bg-[#0b1f33] hover:bg-[#102a43] disabled:bg-slate-700 text-white rounded-lg text-xs font-bold transition flex items-center justify-center gap-2 shadow-xs"
          >
            {loading ? (
        ...
        {mode === 'login' && (
          <div className="mt-5 p-3.5 rounded-xl bg-slate-50 border border-slate-200">
            <div className="text-[11px] font-bold text-slate-700 mb-2 flex items-center justify-between">
              <span className="flex items-center gap-1.5 text-[#0b1f33]">
            ...
            <div className="space-y-1.5 text-[11px]">
              <div className="flex items-center justify-between p-2 rounded-lg bg-white border border-slate-200">
                <div>
                  ...
                  <span className="font-mono text-slate-600">admin@pragati.ac.in</span>
                </div>
                <button
                  type="button"
                  onClick={() => fillTestCredentials('admin@pragati.ac.in', 'Password123!')}
                  className="px-2 py-0.5 rounded bg-slate-100 text-[#0b1f33] hover:bg-slate-200 font-semibold border border-slate-300 text-[10px]"
                >
                  Use Fill
                </button>
              </div>
              ...
              <div className="flex items-center justify-between p-2 rounded-lg bg-white border border-slate-200">
                <div>
                  ...
                  <span className="font-mono text-slate-600">faculty.ece@pragati.ac.in</span>
                </div>
                <button
                  type="button"
              ...
              <div className="flex items-center justify-between p-2 rounded-lg bg-white border border-slate-200">
                <div>
                  ...
                  <span className="font-mono text-slate-600">23A31A0501</span>
                </div>
                <button
                  type="button"
